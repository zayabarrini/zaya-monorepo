import { f as fallback, i as escape_html, j as ensure_array_like, a as attr_class, d as stringify, b as bind_props, c as clsx, h as head } from "../../../../../chunks/vendor-svelte.js";
function Letters($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let title = fallback($$props["title"], "الأبجدية - Arabic Alphabet Conjugation");
    const consonants = [
      { letter: "ب", name: "Bāʾ (B)" },
      { letter: "ت", name: "Tāʾ (T)" },
    ...
    const columns = [
      { symbol: "َ", name: "Fatḥa", translit: "a", class: "fatha" },
      {
        symbol: "ُ",
        name: "Ḍamma",
        translit: "u",
      ...
      { symbol: "ِ", name: "Kasra", translit: "i", class: "kasra" },
      {
        symbol: "ً",
        name: "Tanwin Fatḥ",
        translit: "an",
      ...
      { symbol: "ْ", name: "Sukūn", translit: "", class: "sukun" },
      {
        symbol: "ّ",
        name: "Shadda",
        translit: "double",
    ...
    function getConjugatedForm(consonant, columnIndex) {
      ...
      if (c === "ء" && columnIndex >= 3 && columnIndex <= 5) return "-";
      if (c === "و" && columnIndex === 8) return "-";
      if (c === "ي" && columnIndex === 7) return "-";
    ...
    $$renderer2.push(`<div class="arabic-conjugation-table svelte-oapwal"><header class="table-header svelte-oapwal"><h1 class="svelte-oapwal">${escape_html(title)}</h1> <p class="subtitle svelte-oapwal">Complete conjugation of Arabic consonants with all
      diacritics</p></header> <section class="legend-section svelte-oapwal"><h2 class="svelte-oapwal">🔤 Diacritic Key</h2> <div class="legend-grid svelte-oapwal"><!--[-->`);
    const each_array = ensure_array_like(columns);
    for (let index = 0, $$length = each_array.length; index < $$length; index++) {
      let col = each_array[index];
      $$renderer2.push(`<div class="legend-item svelte-oapwal"><span${attr_class(`legend-symbol ${stringify(col.class)}`, "svelte-oapwal")}>${escape_html(col.symbol)}</span> <span class="legend-name svelte-oapwal">${escape_html(col.name)}</span> <span class="legend-translit svelte-oapwal">${escape_html(col.translit)}</span></div>`);
    }
    $$renderer2.push(`<!--]--></div></section> <div class="table-container svelte-oapwal"><table class="svelte-oapwal"><thead><tr class="svelte-oapwal"><th class="sticky-col svelte-oapwal">Consonant</th><!--[-->`);
    const each_array_1 = ensure_array_like(columns);
    for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
      let col = each_array_1[$$index_1];
      $$renderer2.push(`<th class="svelte-oapwal"><div class="column-header svelte-oapwal"><span${attr_class(`header-symbol ${stringify(col.class)}`, "svelte-oapwal")}>${escape_html(col.symbol)}</span> <span class="header-name svelte-oapwal">${escape_html(col.name)}</span></div></th>`);
    }
    $$renderer2.push(`<!--]--></tr></thead><tbody class="svelte-oapwal"><!--[-->`);
    const each_array_2 = ensure_array_like(consonants);
    for (let $$index_3 = 0, $$length = each_array_2.length; $$index_3 < $$length; $$index_3++) {
      let consonant = each_array_2[$$index_3];
      $$renderer2.push(`<tr class="svelte-oapwal"><td class="sticky-col consonant-cell svelte-oapwal"><span class="consonant-symbol svelte-oapwal">${escape_html(consonant.letter)}</span> <span class="consonant-name svelte-oapwal">${escape_html(consonant.name)}</span></td><!--[-->`);
      const each_array_3 = ensure_array_like(columns);
      for (let index = 0, $$length2 = each_array_3.length; index < $$length2; index++) {
        each_array_3[index];
        const form = getConjugatedForm(consonant, index);
        $$renderer2.push(`<td class="conjugation-cell svelte-oapwal">`);
        if (form === "-") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<span class="empty-cell svelte-oapwal">—</span>`);
        } else {
          $$renderer2.push("<!--[!-->");
          $$renderer2.push(`<div class="conjugation-content svelte-oapwal"><span class="arabic-form svelte-oapwal">${escape_html(form.split(" ")[0])}</span> <span class="transliteration svelte-oapwal">${escape_html(form.split(" ")[1])}</span></div>`);
        }
        $$renderer2.push(`<!--]--></td>`);
      }
      $$renderer2.push(`<!--]--></tr>`);
    }
    $$renderer2.push(`<!--]--></tbody></table></div> <footer class="table-footer svelte-oapwal"><div class="notes-grid svelte-oapwal"><div class="note-card svelte-oapwal"><h3 class="svelte-oapwal">📝 How to Read</h3> <p class="svelte-oapwal">Each cell shows the consonant with its diacritic,
...
function Alphabet($$renderer, $$props) {
  ...
  const nonConnectingLetters = [
    ...
    },
    {
      ...
      isolated: "د",
      final: "ـد",
      example: "مَدْرَسَة (madrasa - school)"
    },
    {
      letter: "ذ",
      name: "Dhāl",
      isolated: "ذ",
      final: "ـذ",
      example: "بِذَكَاء (bidhakāʾ - with intelligence)"
    },
    {
      letter: "ر",
      name: "Rāʾ",
    ...
    },
    {
      ...
      isolated: "ز",
      final: "ـز",
      example: "مِزْيَة (mizya - advantage)"
    },
    {
      letter: "و",
      name: "Wāw",
      isolated: "و",
      final: "ـو",
      example: "مَوْعِد (mawʿid - appointment)"
    }
  ];
  ...
  const hamzaTypes = [
    { symbol: "ء", name: "Hamza on the line (stand-alone)" },
    { symbol: "أ", name: "Hamza on alif with fatha (ʾa)" },
    { symbol: "إ", name: "Hamza on alif with kasra (ʾi)" },
    { symbol: "ؤ", name: "Hamza on waw (ʾu)" },
    { symbol: "ئ", name: "Hamza on ya’ (ʾi in middle or end)" },
    {
      symbol: "ئـ",
      name: "Initial or medial hamza on ya’ without dots"
    },
    {
      symbol: "ء",
      name: "Hamza on the line at word end (e.g., شيء)"
    },
    {
      symbol: "ٱ",
      name: "Alif wasla (non-pronounced alif in context)"
    },
    { symbol: "ٱ", name: "Connective hamza (همزة وصل)" },
    {
      symbol: "ء",
      name: "Glottal stop (همزة القطع), always pronounced"
    }
  ];
  const diacriticSymbols = [
    { symbol: "َ", name: "Fatḥa (a)", class: "fatha" },
    { symbol: "ِ", name: "Kasra (i)", class: "kasra" },
    { symbol: "ُ", name: "Ḍamma (u)", class: "vowel-symbol" },
    { symbol: "ْ", name: "Sukūn (no vowel)", class: "sukun" },
    {
      symbol: "ّ",
      name: "Shadda (consonant doubling)",
      class: "shadda"
    },
    { symbol: "ً", name: "Tanwīn fatḥa (an)", class: "tanwin" },
    { symbol: "ٍ", name: "Tanwīn kasra (in)", class: "tanwin" },
    { symbol: "ٌ", name: "Tanwīn ḍamma (un)", class: "tanwin" },
    {
      symbol: "ٰ",
      name: "Alif khanjariyya (dagger alif)",
      class: "dagger-alif"
    },
    {
      symbol: "ــ",
      name: "Tatweel (kashida, elongation)",
      class: "tatweel"
    }
  ];
  const visualExamples = [
    {
      ...
      meaning: "house",
      note: "ي connects ب to ت"
    },
    {
      word: "بَاب",
      transliteration: "bāb",
      meaning: "door",
      note: "ا breaks connection"
    },
    {
      word: "دَاوُد",
      transliteration: "Dāwūd",
      meaning: "David",
      note: "All non-connectors!"
    },
    {
      word: "مَوْز",
      transliteration: "mawz",
      meaning: "banana",
      note: "و connects to م only"
    }
  ];
  $$renderer.push(`<div class="arabic-guide svelte-b85ynd"><header class="guide-header svelte-b85ynd"><h1 class="svelte-b85ynd">${escape_html(title)}</h1> <p class="subtitle svelte-b85ynd">A comprehensive guide to Arabic script, diacritics,
      and letter forms</p></header> <section class="symbols-section"><h2 class="svelte-b85ynd">✨ Arabic Diacritics &amp; Symbols</h2> <p class="section-intro svelte-b85ynd">Using the <code class="inline-code svelte-b85ynd">.vowel-symbol</code> class for proper rendering</p> <div class="symbols-grid svelte-b85ynd"><!--[-->`);
  const each_array = ensure_array_like(diacriticSymbols);
  for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
    let symbol = each_array[$$index];
    $$renderer.push(`<div class="symbol-card svelte-b85ynd"><div class="symbol-display svelte-b85ynd"><span${attr_class(clsx(symbol.class), "svelte-b85ynd")}>${escape_html(symbol.symbol)}</span></div> <div class="symbol-name svelte-b85ynd">${escape_html(symbol.name)}</div></div>`);
  }
  $$renderer.push(`<!--]--></div> <div class="example-box svelte-b85ynd"><p class="example-title">Example rendering:</p> <p class="arabic-example svelte-b85ynd">ب<span class="vowel-symbol svelte-b85ynd">َ</span>ي<span class="vowel-symbol svelte-b85ynd">ْ</span>ت <span class="example-translit svelte-b85ynd">(bayt)</span> ← Notice the <span class="vowel-symbol svelte-b85ynd">ُ</span> (ḍamma)
        and other marks</p></div></section> <section class="hamza-section"><h2 class="svelte-b85ynd">📍 Hamza Placement Types</h2> <div class="hamza-container svelte-b85ynd"><div class="hamza-list svelte-b85ynd"><!--[-->`);
  const each_array_1 = ensure_array_like(hamzaTypes);
  for (let index = 0, $$length = each_array_1.length; index < $$length; index++) {
    let hamza = each_array_1[index];
    $$renderer.push(`<div class="hamza-item svelte-b85ynd"><span class="hamza-symbol svelte-b85ynd">${escape_html(hamza.symbol)}</span> <span class="hamza-description svelte-b85ynd">${escape_html(hamza.name)}</span></div>`);
  }
  $$renderer.push(`<!--]--></div></div></section> <section class="non-connectors"><h2 class="svelte-b85ynd">🔹 Non-Connecting Letters (الحروف المتكبرة)</h2> <p class="section-note svelte-b85ynd">These letters connect to the previous letter but NEVER
      to the following letter</p> <div class="non-connector-table svelte-b85ynd"><div class="table-header svelte-b85ynd"><span>Letter</span> <span>Name</span> <span>Isolated</span> <span>Final</span> <span>Example</span></div> <!--[-->`);
  const each_array_2 = ensure_array_like(nonConnectingLetters);
  for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
    let letter = each_array_2[$$index_2];
    $$renderer.push(`<div class="table-row svelte-b85ynd"><span class="letter-cell large svelte-b85ynd">${escape_html(letter.letter)}</span> <span class="name-cell svelte-b85ynd">${escape_html(letter.name)}</span> <span class="form-cell svelte-b85ynd">${escape_html(letter.isolated)}</span> <span class="form-cell svelte-b85ynd">${escape_html(letter.final)}</span> <span class="example-cell svelte-b85ynd">${escape_html(letter.example)}</span></div>`);
  }
  $$renderer.push(`<!--]--></div> <div class="mnemonic-box svelte-b85ynd"><p><strong>Mnemonic:</strong> <span class="arabic-text svelte-b85ynd">ا د ذ ر ز و</span> — Letters
        that "fall below the line"</p></div></section> <section class="examples-section"><h2 class="svelte-b85ynd">🔍 Visualizing the "Break"</h2> <div class="examples-grid svelte-b85ynd"><!--[-->`);
  const each_array_3 = ensure_array_like(visualExamples);
  for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
    let ex = each_array_3[$$index_3];
    $$renderer.push(`<div class="example-card svelte-b85ynd"><div class="example-word svelte-b85ynd">${escape_html(ex.word)}</div> <div class="example-details svelte-b85ynd"><span class="translit svelte-b85ynd">${escape_html(ex.transliteration)}</span> <span class="meaning svelte-b85ynd">${escape_html(ex.meaning)}</span> <span class="note svelte-b85ynd">${escape_html(ex.note)}</span></div></div>`);
  }
  $$renderer.push(`<!--]--></div></section> <section class="connecting-letters"><h2 class="svelte-b85ynd">📊 Letters That Change Shape</h2> <p class="section-note svelte-b85ynd">Arabic letters have up to four forms: isolated,
      initial, medial, and final</p> <div class="table-container svelte-b85ynd"><table class="svelte-b85ynd"><thead><tr class="svelte-b85ynd"><th class="svelte-b85ynd">Letter Name</th><th class="svelte-b85ynd">Isolated</th><th class="svelte-b85ynd">Initial</th><th class="svelte-b85ynd">Medial</th><th class="svelte-b85ynd">Final</th></tr></thead><tbody><!--[-->`);
  const each_array_4 = ensure_array_like(connectingLetters);
  for (let $$index_4 = 0, $$length = each_array_4.length; $$index_4 < $$length; $$index_4++) {
    let letter = each_array_4[$$index_4];
    $$renderer.push(`<tr class="svelte-b85ynd"><td class="letter-name svelte-b85ynd">${escape_html(letter.name)}</td><td class="arabic-form svelte-b85ynd">${escape_html(letter.isolated)}</td><td class="arabic-form svelte-b85ynd">${escape_html(letter.initial)}</td><td class="arabic-form svelte-b85ynd">${escape_html(letter.medial)}</td><td class="arabic-form svelte-b85ynd">${escape_html(letter.final)}</td></tr>`);
  }
  $$renderer.push(`<!--]--></tbody></table></div></section> <footer class="guide-footer svelte-b85ynd"><p>✨ In Arabic calligraphy, non-connecting letters are
      ...
      diacritics are rendered with the vowel-symbol class</p></footer></div>`);
  bind_props($$props, { title });
}
function Numbers($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let title = fallback($$props["title"], "العد - Arabic Numbers Table");
    let subtitle = fallback($$props["subtitle"], "جدول الأرقام العربية (Arabic Numerals Conjugation)");
    const tens = [
      { arabic: "٠", name: "صفر", translit: "sifr", value: 0 },
      { arabic: "١٠", name: "عشرة", translit: "ʿashara", value: 10 },
      { arabic: "٢٠", name: "عشرون", translit: "ʿishrūn", value: 20 },
      {
        arabic: "٣٠",
        name: "ثلاثون",
        translit: "thalāthūn",
      ...
      { arabic: "٤٠", name: "أربعون", translit: "arbaʿūn", value: 40 },
      { arabic: "٥٠", name: "خمسون", translit: "khamsūn", value: 50 },
      { arabic: "٦٠", name: "ستون", translit: "sittūn", value: 60 },
      { arabic: "٧٠", name: "سبعون", translit: "sabʿūn", value: 70 },
      {
        arabic: "٨٠",
        name: "ثمانون",
        translit: "thamānūn",
      ...
      { arabic: "٩٠", name: "تسعون", translit: "tisʿūn", value: 90 },
      { arabic: "١٠٠", name: "مائة", translit: "miʾa", value: 100 }
    ];
    const units = [
      { arabic: "٠", name: "صفر", translit: "sifr", value: 0 },
      { arabic: "١", name: "واحد", translit: "wāḥid", value: 1 },
      { arabic: "٢", name: "اثنان", translit: "ithnān", value: 2 },
      { arabic: "٣", name: "ثلاثة", translit: "thalātha", value: 3 },
      { arabic: "٤", name: "أربعة", translit: "arbaʿa", value: 4 },
      { arabic: "٥", name: "خمسة", translit: "khamsa", value: 5 },
      { arabic: "٦", name: "ستة", translit: "sitta", value: 6 },
      { arabic: "٧", name: "سبعة", translit: "sabʿa", value: 7 },
      { arabic: "٨", name: "ثمانية", translit: "thamāniya", value: 8 },
      { arabic: "٩", name: "تسعة", translit: "tisʿa", value: 9 }
    ];
    const ordinals = [
      { arabic: "الأول", translit: "al-awwal", english: "first" },
      { arabic: "الثاني", translit: "ath-thānī", english: "second" },
      { arabic: "الثالث", translit: "ath-thālith", english: "third" },
      { arabic: "الرابع", translit: "ar-rābiʿ", english: "fourth" },
      { arabic: "الخامس", translit: "al-khāmis", english: "fifth" },
      { arabic: "السادس", translit: "as-sādis", english: "sixth" },
      { arabic: "السابع", translit: "as-sābiʿ", english: "seventh" },
      { arabic: "الثامن", translit: "ath-thāmin", english: "eighth" },
      { arabic: "التاسع", translit: "at-tāsiʿ", english: "ninth" },
      { arabic: "العاشر", translit: "al-ʿāshir", english: "tenth" },
      {
        arabic: "الحادي عشر",
        translit: "al-ḥādī ʿashar",
        english: "eleventh"
      }
    ];
    const numberTable = [
    ...
    const numbers1to100 = [];
    for (let i = 1; i <= 100; i++) {
      numbers1to100.push(i.toString());
    }
    const numbers101to120 = [];
    for (let i = 101; i <= 120; i++) {
      numbers101to120.push(i.toString());
    }
    const years = [];
    for (let i = 1990; i <= 2035; i++) {
      years.push(i.toString());
    }
    const hundreds = [200, 300, 400, 500, 600, 700, 800, 900, 1e3];
    function toArabicNumerals(num) {
      const arabicDigits = ["٠", "١", "٢", "٣", "٤", "٥", "٦", "٧", "٨", "٩"];
      return num.toString().replace(/\d/g, (d) => arabicDigits[parseInt(d)]);
    }
    $$renderer2.push(`<div class="arabic-numbers-container svelte-1n98trm" dir="rtl"><header class="table-header svelte-1n98trm"><h1 class="svelte-1n98trm">${escape_html(title)}</h1> <p class="subtitle svelte-1n98trm">${escape_html(subtitle)}</p> <div class="header-decoration svelte-1n98trm"><span class="decoration-symbol svelte-1n98trm">🔢</span> <span class="decoration-text svelte-1n98trm">الأرقام العربية</span> <span class="decoration-symbol svelte-1n98trm">١٢٣</span></div></header> <section class="table-section"><h2 class="svelte-1n98trm">📊 جدول الأرقام (Numbers Table)</h2> <div class="table-container svelte-1n98trm"><table class="svelte-1n98trm"><thead><tr><th class="sticky-col svelte-1n98trm">الآحاد<br/><span class="subhead svelte-1n98trm">(Units)</span></th><!--[-->`);
    const each_array = ensure_array_like(tens);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let ten = each_array[$$index];
      $$renderer2.push(`<th class="svelte-1n98trm"><div class="ten-header svelte-1n98trm"><span class="arabic-number svelte-1n98trm">${escape_html(ten.arabic)}</span> <span class="translit svelte-1n98trm">${escape_html(ten.name)}</span> <span class="small-text">${escape_html(ten.translit)}</span></div></th>`);
    }
    $$renderer2.push(`<!--]--></tr></thead><tbody class="svelte-1n98trm"><!--[-->`);
    const each_array_1 = ensure_array_like(numberTable);
    for (let $$index_2 = 0, $$length = each_array_1.length; $$index_2 < $$length; $$index_2++) {
      let row = each_array_1[$$index_2];
      $$renderer2.push(`<tr class="svelte-1n98trm"><td class="sticky-col unit-cell svelte-1n98trm"><span class="arabic-number svelte-1n98trm">${escape_html(units[row.unit].arabic)}</span> <span class="unit-name svelte-1n98trm">${escape_html(row.name)}</span> <span class="translit small svelte-1n98trm">${escape_html(units[row.unit].translit)}</span></td><!--[-->`);
      const each_array_2 = ensure_array_like(row.values);
      for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
        let value = each_array_2[$$index_1];
        $$renderer2.push(`<td class="number-cell svelte-1n98trm">`);
        if (value === "—") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<span class="empty-cell svelte-1n98trm">—</span>`);
        } else {
          $$renderer2.push("<!--[!-->");
          $$renderer2.push(`<span class="arabic-text svelte-1n98trm">${escape_html(value)}</span>`);
        }
        $$renderer2.push(`<!--]--></td>`);
      }
      $$renderer2.push(`<!--]--></tr>`);
    }
    $$renderer2.push(`<!--]--></tbody></table></div></section> <section class="info-cards svelte-1n98trm"><div class="info-card svelte-1n98trm"><h3 class="svelte-1n98trm">مليون (Million)</h3> <div class="large-number svelte-1n98trm"><span class="arabic-digit svelte-1n98trm">١٬٠٠٠٬٠٠٠</span> <span class="translit svelte-1n98trm">million</span></div></div> <div class="info-card svelte-1n98trm"><h3 class="svelte-1n98trm">مليار (Billion)</h3> <div class="large-number svelte-1n98trm"><span class="arabic-digit svelte-1n98trm">١٬٠٠٠٬٠٠٠٬٠٠٠</span> <span class="translit svelte-1n98trm">billion</span></div></div> <div class="info-card svelte-1n98trm"><h3 class="svelte-1n98trm">سنتيم (Centimeter)</h3> <div class="large-number svelte-1n98trm"><span class="arabic-digit svelte-1n98trm">سم</span> <span class="translit svelte-1n98trm">santīm</span></div></div></section> <section class="ordinal-section svelte-1n98trm"><h2 class="svelte-1n98trm">🔢 الأعداد الترتيبية (Ordinal Numbers)</h2> <div class="ordinal-grid svelte-1n98trm"><!--[-->`);
    const each_array_3 = ensure_array_like(ordinals);
    for (let $$index_3 = 0, $$length = each_array_3.length; $$index_3 < $$length; $$index_3++) {
      let ordinal = each_array_3[$$index_3];
      $$renderer2.push(`<div class="ordinal-card svelte-1n98trm"><span class="ordinal-arabic svelte-1n98trm">${escape_html(ordinal.arabic)}</span> <span class="ordinal-translit svelte-1n98trm">${escape_html(ordinal.translit)}</span> <span class="ordinal-english svelte-1n98trm">${escape_html(ordinal.english)}</span></div>`);
    }
    $$renderer2.push(`<!--]--></div></section> <section class="sequence-section svelte-1n98trm"><h2 class="svelte-1n98trm">١-١٠٠ (Numbers 1 to 100)</h2> <div class="number-grid svelte-1n98trm"><!--[-->`);
    const each_array_4 = ensure_array_like(numbers1to100);
    for (let $$index_4 = 0, $$length = each_array_4.length; $$index_4 < $$length; $$index_4++) {
      let num = each_array_4[$$index_4];
      $$renderer2.push(`<span class="number-item svelte-1n98trm">${escape_html(toArabicNumerals(num))}</span>`);
    }
    $$renderer2.push(`<!--]--></div></section> <section class="sequence-section svelte-1n98trm"><h2 class="svelte-1n98trm">١٠١-١٢٠ (Numbers 101 to 120)</h2> <div class="number-grid svelte-1n98trm"><!--[-->`);
    const each_array_5 = ensure_array_like(numbers101to120);
    for (let $$index_5 = 0, $$length = each_array_5.length; $$index_5 < $$length; $$index_5++) {
      let num = each_array_5[$$index_5];
      $$renderer2.push(`<span class="number-item svelte-1n98trm">${escape_html(toArabicNumerals(num))}</span>`);
    }
    $$renderer2.push(`<!--]--></div></section> <section class="sequence-section svelte-1n98trm"><h2 class="svelte-1n98trm">المئات (Hundreds)</h2> <div class="number-grid svelte-1n98trm"><!--[-->`);
    const each_array_6 = ensure_array_like(hundreds);
    for (let $$index_6 = 0, $$length = each_array_6.length; $$index_6 < $$length; $$index_6++) {
      let num = each_array_6[$$index_6];
      $$renderer2.push(`<span class="number-item svelte-1n98trm">${escape_html(toArabicNumerals(num))}</span>`);
    }
    $$renderer2.push(`<!--]--></div></section> <section class="sequence-section svelte-1n98trm"><h2 class="svelte-1n98trm">السنوات (Years 1990-2035)</h2> <div class="number-grid years-grid svelte-1n98trm"><!--[-->`);
    const each_array_7 = ensure_array_like(years);
    for (let $$index_7 = 0, $$length = each_array_7.length; $$index_7 < $$length; $$index_7++) {
      let year = each_array_7[$$index_7];
      $$renderer2.push(`<span class="number-item year-item svelte-1n98trm">${escape_html(toArabicNumerals(year))}</span>`);
    }
    $$renderer2.push(`<!--]--></div></section> <section class="date-example svelte-1n98trm"><h2 class="svelte-1n98trm">📅 مثال التاريخ (Date Example)</h2> <div class="date-card svelte-1n98trm"><span class="date-arabic svelte-1n98trm">١٦/٠٥/٢٠٢٤</span> <span class="date-explanation svelte-1n98trm">16 مايو 2024</span></div></section> <footer class="table-footer svelte-1n98trm"><p>الأعداد العربية - نظام العد والترقيم</p> <p class="small svelte-1n98trm">Arabic numerals - Counting and numbering system</p></footer></div>`);
    bind_props($$props, { title, subtitle });
  });
}
function _page($$renderer) {
  head("2ertku", $$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Arabic Spelling Mastery - Complete Guide</title>`);
    });
    $$renderer2.push(`<meta charset="UTF-8" class="svelte-2ertku"/> <meta name="viewport" content="width=device-width, initial-scale=1.0" class="svelte-2ertku"/> `);
    $$renderer2.push(`<script class="svelte-2ertku">
  ...
  $$renderer.push(`<div class="container mainpage svelte-2ertku"><div class="container svelte-2ertku"><header class="svelte-2ertku"><h1 class="svelte-2ertku">Arabic Spelling Mastery</h1> <p class="subtitle svelte-2ertku">Complete Guide to Letters, Vowels, and Word
        ...
        then gradually move to unvoweled texts</p></footer> `);
  Letters($$renderer, {});
  $$renderer.push(`<!----> `);
  Alphabet($$renderer, {});
  $$renderer.push(`<!----> `);
