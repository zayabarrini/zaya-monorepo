import{a as e,f as N}from"./-0HexQLS.js";const T={title:"Dictionary-Philosophy",imgUrl:"/css/img/Bing/bing185.png",youtubeId:"",publishedAt:"2025-12-07",updatedAt:"2025-12-07",summary:"Dictionary-Philosophy"},{title:A,imgUrl:n,youtubeId:O,publishedAt:t,updatedAt:R,summary:r}=T;var i=N(`<p>ALLEMAND
...
encadré 7 ; voir Vorstellung – List der Vernunft ◆ TALAT * <em>TUF – praktischen Vernunft ◆ PHRONÊSIS
...
‘ālam ◆ ‘O z LA zM
Allah ◆ DIEU, TALAT</em>T <em>UF
al-mus</em> awwina ◆ INTELLECTUS encadré 6, INTENTION encadré 2, SENSUS COMMUNIS
...
bant <em>asiā ◆ INTENTION encadré 2, SENSUS COMMUNIS
...
ġūl ◆ DIABLE III
h</em> add, h <em>udūd ◆ TORAH II
ARABE
h</em> ads ◆ INGENIUM encadré 1 , TERME encadré 2
h <em>aqı̄qa ◆ RES V, TO TI ÊN EINAI I
h</em> aqq ◆ TORAH I
hayūlā ◆ LANGUES ET TRADITIONS VI
h <em>ikma ◆ LANGUES ET TRADITIONS III
‘illa ◆ LANGUES ET TRADITIONS VI
ittisal ◆ LANGUES ET TRADITIONS VI
kulliyya ◆ LANGUES ET TRADITIONS VI
lat</em>ı̄f ◆ TALAT <em>T</em> UF
lubb ◆ LËV
lut <em>f ◆ TALAT</em>T <em>UF
...
mı̄t Iāq ◆ BERI zT I
mut</em>ābiq ◆ VÉRITÉ IIIC
nāmūs, nawāmı̄s ◆ TORAH II
qalb ◆ LËV
sabab ◆ LANGUES ET TRADITIONS VI
sadı̄q <em>◆ VÉRITÉ IIIC
šaffa ◆ DIAPHANE
šarı̄‘a (chariah) ◆ TORAH
šay’ ◆ RES encadré 1
šay’iyya ◆ RES encadré 2
šayt</em>ān, šayāt <em>ı̄n ◆ DIABLE I
sidq</em> ◆ VÉRITÉ IIIC
sunna ◆ TORAH II
sūra ◆ LANGUES ET TRADITIONS VII <em>ab‘, t</em>abı̄‘ t ◆ LANGUES ET TRADITIONS VI
talat <em>t</em>uf → RUSE, SAGESSE ◆ TALAT <em>T</em> UF
‘uns <em>ur ◆ LANGUES ET TRADITIONS VI
ust</em>uqus ◆ LANGUES ET TRADITIONS VI
...
TALAT <em>T</em>UF – acte de l’esprit, de jugement, etc ◆ INTENTION, SACHVERHALT – acte d’être ◆ ESSENCE IC
...
SÉCULARISATION, TALAT <em>T</em>UF, THEMIS
...
lignée</p>`);function a(I){var E=i();e(I,E)}export{a as default,T as metadata};
