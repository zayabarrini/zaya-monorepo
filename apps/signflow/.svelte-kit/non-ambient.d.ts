...
declare module "$app/types" {
	export interface AppTypes {
		...
		Asset(): "/json/1000-Sentences.json" | "/json/Arabic-Phonetics.json" | "/json/Asti.json" | "/json/Doubt.json" | "/json/Freq/Table of content - 100000ch.json" | "/json/Freq/Table of content - JapFreq.json" | "/json/Freq/ar.json" | "/json/Freq/chinese-japanese-overlap.json" | "/json/Freq/de.json" | "/json/Freq/fr.json" | "/json/Freq/hi.json" | "/json/Freq/it.json" | "/json/Freq/ru.json" | "/json/PoS.json" | "/json/Sentences.json" | "/json/Verb-Tense.json" | "/json/Words.json" | "/json/arabic-vocab-enhanced.json" | "/json/ch/epub_content_web-doubt.json" | "/json/ch/epub_content_web-downton.json" | "/json/ja/epub_content_web-Downton-abbey.json" | "/json/zh/epub_content_web-downton-db.json" | string & {};
	}
}