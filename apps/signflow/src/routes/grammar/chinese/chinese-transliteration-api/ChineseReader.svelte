<!-- /home/zaya/Downloads/Zayas/zaya-monorepo/apps/signflow/src/routes/grammar/chinese/chinese-transliteration-api/ChineseReader.svelte -->
...
<script lang="ts">
  ...
  interface WordAnalysis {
    ...
    pos_tag?: string; // Original jieba POS tag
  }
...
<!-- Styles (similar to JapaneseReader but with Chinese-specific colors) -->
<style>
  ...
  * {
  ...
  /* Word Container */
  .chinese-reader :global(.word-container) {
    display: inline-flex;
  ...
  .chinese-reader :global(.word-container:hover) {
  ...
  /* Word field */
  .chinese-reader :global(.word-field) {
    font-size: 2rem;
    font-weight: 600;
    color: #2c3e50;
    font-family: 'Noto Sans SC', 'Microsoft YaHei', sans-serif;
  ...
  .chinese-reader :global(.transliteration-field) {
    font-size: 0.85rem;
    color: #666;
    font-style: italic;
  ...
  /* Translation field */
  .chinese-reader :global(.translation-field) {
    font-size: 0.8rem;
    color: #2c3e50;
  ...
  /* Metadata fields */
  .chinese-reader :global(.pos-field),
  .chinese-reader :global(.syntax-field),
  .chinese-reader :global(.semantic-field) {
    font-size: 0.65rem;
  ...
  .chinese-reader :global(.word-noun) {
    background: linear-gradient(135deg, #f1f8e9, #dcedc8);
    border-color: #8bc34a;
  }

  .chinese-reader :global(.word-verb) {
    background: linear-gradient(135deg, #ffebee, #ffcdd2);
    border-color: #ef5350;
  }

  .chinese-reader :global(.word-pronoun) {
    background: linear-gradient(135deg, #efebe9, #d7ccc8);
    border-color: #8d6e63;
  }

  .chinese-reader :global(.word-adjective) {
    background: linear-gradient(135deg, #f3e5f5, #e1bee7);
    border-color: #ab47bc;
  }

  .chinese-reader :global(.word-adverb) {
    background: linear-gradient(135deg, #e0f7fa, #b2ebf2);
    border-color: #26c6da;
  }

  .chinese-reader :global(.word-preposition) {
    background: linear-gradient(135deg, #fff3e0, #ffe0b2);
    border-color: #ffa726;
  }

  .chinese-reader :global(.word-conjunction) {
    background: linear-gradient(135deg, #e1f5fe, #b3e5fc);
    border-color: #42a5f5;
  }

  .chinese-reader :global(.word-particle) {
