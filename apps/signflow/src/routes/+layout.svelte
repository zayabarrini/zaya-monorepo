<script lang="ts">
  ...
  import "./style.css";
  import ReadAloudSmartLanguageDetection from "$lib/components/ReadAloudSmartLanguageDetection.svelte";
  import ReadAloudOneClickLineDblClickWord from "$lib/components/ReadAloudOneClickLineDblClickWord.svelte";
...
<svelte:head>
  ...
  />
  <link
    href="https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Satisfy&display=swap"
    rel="stylesheet"
  />
  <link
    href="https://fonts.googleapis.com/css?family=Playball|Sedgwick+Ave+Display|Zilla+Slab+Highlight"
    rel="stylesheet"
  />
  <link
    href="https://fonts.googleapis.com/css?family=Indie+Flower|Lora|Pacifico|Playfair+Display|Roboto|Roboto+Condensed|Slabo+27px"
    rel="stylesheet"
  />
  <script
  ...
  {#key pagePath}
    <div class="">
      ...
      >
        ...
        <InstallButton />
        <!-- <ReadAloud /> -->
        <ReadAloudSmartLanguageDetection />
        <!-- <ReadAloudOneClickLineDblClickWord /> -->
