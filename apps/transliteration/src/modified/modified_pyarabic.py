...
if sys.version_info > (3, 0):
    ...
    T2D_TRANS = {c: t for c, t in zip(ar.NOT_DEF_HARAKA + ar.TASHKEEL_STRING, "012345678")}
    T2A_TRANS = {c: t for c, t in zip(ar.NOT_DEF_HARAKA + ar.TASHKEEL_STRING, "0AUIauio3")}
    D2T_TRANS = {c: t for c, t in zip("012345678", ar.NOT_DEF_HARAKA + ar.TASHKEEL_STRING)}
    A2T_TRANS = {c: t for c, t in zip("0AUIauio3", ar.NOT_DEF_HARAKA + ar.TASHKEEL_STRING)}
